...
const addAddress = async (req, res, next) => {
    try {
        ...
        } else return response.failedWithMessage('User not existed!!!', res)
...
const updateAddress = async (req, res, next) => {
    try {
        ...
        } else response.failedWithMessage('Address detail can not be empty!!!', res)
